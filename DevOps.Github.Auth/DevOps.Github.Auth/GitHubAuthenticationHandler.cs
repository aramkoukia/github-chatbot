            ...
            try
            {
                ...
                else if (Options.Scope.Any(x=> x == "user" || x == "user:email"))
                {
                    ...
                    if (emails.Any())
                    {
                        ...
                        {
                            context.Identity.AddClaim(new Claim(ClaimTypes.Email, primaryEmail.Email, XmlSchemaString, Options.AuthenticationType));
                        }
                    }
                }
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:github:accesstoken", context.AccessToken, XmlSchemaString, Options.AuthenticationType));
                }
